                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class="row px-3 mb-4">
                            <div></div><h2 class="form-login-heading fs-3">USER REGISTRATION</h2></small>
                        ...
                        <div class="row px-3"> <label class="mb-1">
                            ...
                            </label> <input class="mb-4 fs-5" type="text" name="fullname" placeholder="Enter your full name" required="required" autofocus> </div>
                        <div class="row px-3"> <label class="mb-1">
                                <h6 class="mb-0 fs-4">Email Address</h6>
                            </label> <input class="mb-4 fs-5" type="email" id="email" onBlur="userAvailability()" name="email" required="required" placeholder="Enter a valid email address"> 
                            <span id="user-availability-status1" style="font-size:12px;"></span>
                        </div>
                        <div class="row px-3 mb-4"> <label class="mb-1">
                                <h6 class="mb-0 fs-4">Password</h6>
                            </label> <input class="fs-5" type="password" name="password" placeholder="Enter password" required="required"> </div>
                        
                        <div class="row px-3"> <label class="mb-1">
                                <h6 class="mb-0 fs-4">Contact Number</h6>
                            </label> <input class="mb-4 fs-5" type="text" maxlength="13" name="contactno" required="required" autofocus placeholder="Enter your contact number"> </div>
