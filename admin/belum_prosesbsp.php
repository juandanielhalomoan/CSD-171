          ...
          <div class="card pt-5">
            <div class="card-body">
              ...
              <table class="table table-bordered border-secondary">
                ...
                <tbody>
                <?php 
                  $query=mysqli_query($bd, "select laporan_user.*,users.nama_lengkap as nama from laporan_user join users on users.id=laporan_user.id_user where laporan_user.status is null ");
                ...
                ?>	
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-danger">Belum diproses</button></td>
                      <td>
