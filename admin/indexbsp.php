                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class="row px-3"> <label class="mb-1">
                            ...
                            </label> <input class="mb-4 fs-5" type="text" placeholder="Enter username" id="inputEmail" name="username" required autofocus> </div>
                        <div class="row px-3 mb-5"> <label class="mb-1">
                                <h6 class="mb-0 fs-4">Password</h6>
                            </label> <input class="fs-5" type="password" id="inputPassword" name="password" placeholder="Enter password" required> </div>
